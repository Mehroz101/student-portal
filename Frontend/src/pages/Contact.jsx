...
const Contact = () => {
  return (
    <div
      ...
      style={{ padding: "100px", minHeight: "80vh" }}
    >
      <div className="contact-container">
        ...
        <div className="contact-text-box">
          <h2>Get in Touch</h2>
          <p>
            <b>Email:</b> info@mnsuet.edu.pk
          </p>
          <p>
            <b>Phone:</b> +92 61 933 0442
          </p>
          <p>
            <b>Address:</b> MNS-UET, Multan, Punjab, Pakistan
          </p>
          <p>
            We value your feedback and inquiries. Please contact us for any
            information or support regarding the university, admissions, or
            events.
          </p>
        </div>
      </div>
      <div className="contact-static-section">
        ...
        <ul>
          <li>
            <b>Monday - Friday:</b> 9:00 AM - 4:00 PM
          </li>
          <li>
            <b>Sunday: Saturday</b> Closed
          </li>
        </ul>
        <h2>Departments</h2>
        <ul>
